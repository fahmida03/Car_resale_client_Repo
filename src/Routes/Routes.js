...
export const router = createBrowserRouter([
    {
        ...
        children: [
            ...
            //     loader: ({params}) => fetch(`https://resale-portal-server-fahmida03.vercel.app/products/${params.id}`)
            // },
        ]
    },
    {
        ...
        children: [
            ...
            },
            {
                ...
                element: <Payment></Payment>,
                loader: ({ params }) => fetch(`https://resale-portal-server-fahmida03.vercel.app/orders/${params.id}`)
            },
        ]
    },
    {
